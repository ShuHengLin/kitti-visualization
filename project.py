...
name = '000002'
img    = '/data_1TB_1/kitti/testing/image_2/' + name + '.png'
binary = '/data_1TB_1/kitti/testing/velodyne/' + name + '.bin'
with open('/data_1TB_1/kitti/testing/calib/' + name + '.txt', 'r') as f:
  calib = f.readlines()
